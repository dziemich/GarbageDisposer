...
public class NBackGame extends Game {
    ...
    private static final int X_BUTTON_GARBAGE = 250;
    private static final int X_BUTTON_GARBAGE_POS = 50;
    private static final int Y_BUTTON_POS = 250;   //ustawić tu zmienne
